        ...
        <div class="col-lg-6 mb-4">
          <div class="card border-0 shadow-sm">
            <div class="card-body p-5">
              ...
              <a href="panggilan-antrian/loket2.php" class="btn btn-success rounded-pill px-4 py-2">
                Loket 2 <i class="bi-chevron-right ms-2"></i>
              </a><br><br>
              <a href="panggilan-antrian/loket3.php" class="btn btn-success rounded-pill px-4 py-2">
                Loket 3 <i class="bi-chevron-right ms-2"></i>
              </a><br><br>
              <a href="panggilan-antrian/loket4.php" class="btn btn-success rounded-pill px-4 py-2">
